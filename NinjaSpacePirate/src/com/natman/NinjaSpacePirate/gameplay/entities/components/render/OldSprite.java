 ...
 * 
 */
public class OldSprite implements Renderable {
	 ...
	 *            The Sprite's origin.
	 */
	public OldSprite(SpriteSheet spriteSheet, String key, Vector2 origin) {
	 ...
	 *            The Sprite's origin.
	 */
	public OldSprite(SpriteSheet spriteSheet, String key) {
	 ...
	 */
	public OldSprite(Texture texture, Rectangle source, Vector2 origin) {
	 ...
	 *            The Sprite's source rectangle.
	 */
	public OldSprite(Texture texture, Rectangle source) {
	 ...
	 *            The Sprite's source rectangle.
	 */
	public OldSprite(Texture texture, TextureRegion source) {
	 ...
	 *            .
	 */
	public OldSprite(Texture texture) {
